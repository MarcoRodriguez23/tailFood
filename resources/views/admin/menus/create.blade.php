                  ...
                  <form method="POST" action="{{route('admin.menus.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1">
                        ...
                        @error('name') border border-red-700 @enderror" />
                      </div>
                      @error('name')
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1">
                        ...
                        @error('price') border border-red-700 @enderror" />
                      </div>
                      @error('price')
                          <div class="text-sm text-red-500">{{ $message }}</div>
                      @enderror
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1">
                        ...
                        @error('image') border border-red-700 @enderror" />
                      </div>
                      @error('image')
                          <div class="text-sm text-red-500">{{ $message }}</div>
                      @enderror
                    ...
                    <div class="sm:col-span-6 pt-5">
                      ...
                      <div class="mt-1">
                        <textarea id="description" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md
                        @error('description') border border-red-700 @enderror"></textarea>
                      </div>
                      @error('description')
                          <div class="text-sm text-red-500">{{ $message }}</div>
                      @enderror
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1">
                        <select id="category" name="category" class="form-multiselect block w-full mt-1
                          @error('category') border border-red-700 @enderror">
